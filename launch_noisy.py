import os
import torch
from launch_utils_noisy import get_argument_parser, get_experience_streams, get_model_config_dict
from launch_utils_noisy import set_seeds, get_log_param_dict, create_log_dirs
...
if __name__ == '__main__':
    ...
    args.number_of_tasks = len(scenario.train_stream)
